...
if [[ "${REPO_BRANCH}" == *"21.02"* ]]; then
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/openwrt-21.02/package/kernel/linux/modules/netfilter.mk -o ${HOME_PATH}/package/kernel/linux/modules/netfilter.mk
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/openwrt-21.02/include/netfilter.mk -o ${HOME_PATH}/include/netfilter.mk
  rm -rf ${HOME_PATH}/feeds/packages/devel/gn
fi

if [[ "${REPO_BRANCH}" == "openwrt-18.06-k5.4" ]]; then
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/openwrt-18.06-k5.4/package/kernel/linux/modules/netfilter.mk -o ${HOME_PATH}/package/kernel/linux/modules/netfilter.mk
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/openwrt-18.06-k5.4/include/netfilter.mk -o ${HOME_PATH}/include/netfilter.mk
fi

if [[ "${REPO_BRANCH}" == "openwrt-18.06" ]]; then
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/openwrt-18.06/package/kernel/linux/modules/netfilter.mk -o ${HOME_PATH}/package/kernel/linux/modules/netfilter.mk
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/openwrt-18.06/include/netfilter.mk -o ${HOME_PATH}/include/netfilter.mk
fi

# 19.07补丁
if [[ "${REPO_BRANCH}" == *"19.07"* ]]; then
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/19.07/include/netfilter.mk -o ${HOME_PATH}/include/netfilter.mk
  curl -fsSL https://raw.githubusercontent.com/ranqingwen/common/main/Share/tproxy/19.07/package/kernel/linux/modules/netfilter.mk -o ${HOME_PATH}/package/kernel/linux/modules/netfilter.mk
...
if [[ "${REPO_BRANCH}" == *"23.05"* ]] && [[ "${SOURCE_CODE}" == "MT798X" ]]; then
  gitsvn https://github.com/ranqingwen/common/tree/main/Share/tproxy/openwrt-23.05/package/kernel/linux/modules/crypto.mk package/kernel/linux/modules/crypto.mk
  gitsvn https://github.com/ranqingwen/common/tree/main/Share/tproxy/openwrt-23.05/package/kernel/linux/modules/netsupport.mk package/kernel/linux/modules/netsupport.mk
